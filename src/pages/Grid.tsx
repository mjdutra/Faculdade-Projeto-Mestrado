  ...
  return (
    <div className="min-h-screen w-full bg-white">
      <TopNav />
        ...
        <Link
              to="/mapa"
              className="fixed z-[60] bottom-6 right-6 z-50 w-10 h-10 flex items-center justify-center rounded-md text-black bg-white hover:bg-black/5 transition-colors"
            >
